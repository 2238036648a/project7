...
<script src="../common/js/jqzoom.js" type="text/javascript"></script>
...
<div class="clearfix  Inside_pages">
 ...
 <div class="Location_link">
  <em></em><a href="#">${data.data.pdName}</a>  &lt;   <a href="#">${data.data.pdTypeName}</a>   &lt;   <a href="#">产品名称</a>
 </div>
 <!--产品详细介绍-->
  ...
  <div class="mod_picfold clearfix">
    <div class="clearfix" id="detail_main_img">
     ...
     <div id="vertical" class="bigImg">
		<img src="../common/mid/01.jpg" width="" height="" alt="" id="midimg" />
     ...
     <div class="smallImg">
		...
		<div id="imageMenu">
			<ul>
				<li><img src="${data.data.pdPicUrl}" width="68" height="68" alt="洋妞"/></li>
				<li><img src="../common/Products/1(32).jpg" width="68" height="68" alt="洋妞"/></li>
				<li><img src="../common/small/03.jpg" width="68" height="68" alt="洋妞"/></li>
				<li><img src="../common/small/04.jpg" width="68" height="68" alt="洋妞"/></li>
				<li><img src="../common/small/05.jpg" width="68" height="68" alt="洋妞"/></li>
				<li><img src="../common/small/06.jpg" width="68" height="68" alt="洋妞"/></li>
                <li><img src="../common/small/07.jpg" width="68" height="68" alt="洋妞"/></li>
			</ul>
		</div>
...
window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{"bdSize":16},"image":{"viewList":["qzone","tsina","tqq","renren","weixin"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tsina","tqq","renren","weixin"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
  ...
  <!--收藏-->
   ...
   <!--信息样式-->
    ...
    <form action="javascript:addToCart(97)" name="ECS_FORMBUY" id="ECS_FORMBUY">
	  <div class="title"><h1>${data.data.pdName}</h1><p>${data.data.pdTypeName}</p></div>
	  <div class="mod_detailInfo_priceSales">
	  <div class="margins">
	  <div class="Price clearfix"><label>价格</label><span>${data.data.pdPrice} <b>34.00</b></span></div>
	 ...
	 <div class="buyinfo" id="detail_buyinfo">
	  ...
	  <dd>
	    <div class="wrap_btn"> <a href="javascript:addToCart_bak(92)" class="wrap_btn1" title="加入购物车"></a>
			...
			<a href="javascript:;" class="wrap_btn2" title="立即购买" onclick="toOrder(${data.data.pdId},num)"></a>
		  </dd>
	  </dl>
	  </div>
	 ...
	 <script type="text/javascript">
		 function reduce() {
			 var c = parseInt($('#buy-num').val());
			 var i = c-1;
			 if(i > 0){
				 $('#buy-num').attr({"value":i});
				 return;
			 }
			 alert('购买数量不能小于0');
		 }
		 ...
		 function toOrder(id,num) {
			 var num = parseInt($('#buy-num').val());
			alert(id);
			alert(num)
			 location.href="/product/order/info?pdId="+id+"&num="+num;
		 }
  ...
  <!--产品推荐-->
    <div class="Recommend">
	  ...
	  <div class="Recommend_list">
	    <ul>
		 <li class="clearfix">
		 <div class="pic_img"><a href=""><img src="../common/Products/x-3.jpg"></a></div>
		 <div class="r_content">
  ...
  <div class="clearfix">
   ...
   <div id="shangpjs"><img src="../common/images/xinxi.png" /></div>
   <div id="miqsp">
...
<div class="Authenticate left clearfix" id="Authenticate_show">
  ...
  <div class="picMarquee-left">
			...
			<div class="bd">
				<ul class="picList">
					<li>
						<div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img src="../common/images/pic1.jpg" /></a></div>
                          <!--<div class="title"><a href="http://www.SuperSlide2.com" target="_blank">效果图1</a></div>-->
                    </li>
					<li>
						<div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img src="../common/images/pic2.jpg" /></a></div>
						<!--<div class="title"><a href="http://www.SuperSlide2.com" target="_blank">效果图2</a></div>-->
					</li>
					<li>
						<div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img src="../common/images/pic3.jpg" /></a></div>

					</li>
					<li>
						<div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img src="../common/images/pic4.jpg" /></a></div>

					</li>
					<li>
						<div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img src="../common/images/pic5.jpg" /></a></div>

					</li>
					<li>
						<div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img src="../common/images/pic6.jpg" /></a></div>
